...
class Notifications extends StatelessWidget {
  ...
  List hotupdate = [
    LatestNews(
        image: "assets/Frame 32 (1).png",
        firsttext: "Monday, 10 May 2021",
        secondtext:
        ...
        forthtext: "Published by Berkeley Lovelace Jr."),
    LatestNews(
        image: "assets/Frame 32.png",
        firsttext: "Sunday, 9 May 2021",
        secondtext:
        ...
        forthtext: "Published by Kristen Rogers")
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: GradientText(
          ...
          colors: const [Color(0xffFF3A44), Color(0xffFF8086)],
        ),
        centerTitle: true,
        leading: IconButton(
          icon: Icon(
